    ...
    <div class="container">
      <div class="row no-gutters">
        <div class="col-lg-4 text-center text-lg-left">
          <a class="text-color mr-3" href="callto:++221 33 951 13 15"><strong>CALL</strong> +44 300 303 0266</a>
...
<!--             <li class="list-inline-item"><a class="text-uppercase text-color p-sm-2 py-2 px-0 d-inline-block" href="notice.html">notice</a></li>
            ...
            <li class="list-inline-item"><a class="text-uppercase text-color p-sm-2 py-2 px-0 d-inline-block" href="#" data-toggle="modal" data-target="#signupModal">Candidature</a></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="collapse navbar-collapse" id="navigation">
          <ul class="navbar-nav ml-auto text-center">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="courses.html">Nos Cours</a>
            </li>
...
<section class="section-sm">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-12 mb-4">
        <h3 class="mb-3">Comment s'inscrire</h3>
        <ul class="list-styled">
...
<section class="section pt-0">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h2 class="section-title">Cours connexes</h2>
      </div>
    </div>
      ...
      <div class="col-lg-4 col-sm-6 mb-5">
        <div class="card p-0 border-primary rounded-0 hover-shadow">
          ...
          <div class="card-body">
            ...
            <a href="course-single.html" class="btn btn-primary btn-sm">Voir plus</a>
          </div>
        </div>
      </div>
      <!-- course item -->
      ...
      <div class="row">
        <div class="col-sm-7 text-sm-left text-center">
          <p class="mb-0">Copyright
            ...
            © Theme By <a href="https://            © Promess 2020<a href="https://promess.ngo">promess.ngo</a></p> . All Rights Reserved.
">            © Promess 2020<a href="https://promess.ngo">promess.ngo</a></p> . All Rights Reserved.
</a></p> . All Rights Reserved.
        </div>
