                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th>ID</th><td>{{ $classe->id }}</td>
                                    </tr>
                                    <tr><th> Name </th><td> {{ $classe->name }} </td></tr><tr><th> Class Numeric </th><td> {{ $classe->class_numeric }} </td></tr><tr><th> Formateur Id </th><td> {{ $classe->formateur_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
