                                    ...
                                    <div class="col-md-3 form-group {{ $errors->has('civilite') ? 'has-error' : ''}}">
                                    ...
                                    <div class="col-md-3 form-group {{ $errors->has('date_naiss') ? 'has-error' : ''}}">
                            ...
                            <div class="col-md-6 form-group">
                             ...
                             @role('superadmin')
                                ...
                                <div class="col-md-6 form-group {{ $errors->has('statut') ? 'has-error' : ''}}">
...
<div class="col-md-2 form-group {{ $errors->has('depot_dossier') ? 'has-error' : ''}}">
...
<div class="col-md-6 form-group {{ $errors->has('parrain') ? 'has-error' : ''}}">
...
<div class="col-md-2 form-group {{ $errors->has('test_ecrit') ? 'has-error' : ''}}">
...
<div class="col-md-2 form-group {{ $errors->has('test_oral') ? 'has-error' : ''}}">
    ...
    <div class="col-md-4 form-group {{ $errors->has('pj_depotdossier') ? 'has-error' : ''}}">
    ...
    <div class="col-md-4 form-group {{ $errors->has('pj_depotdossier') ? 'has-error' : ''}}">
        ...
        {!! $errors->first('pj_depotdossier2', '<p class="help-block">:message</p>') !!}
         ...
         <div class="col-md-6 form-group {{ $errors->has('test_pj') ? 'has-error' : ''}}">
        ...
        <div class="col-md-6 form-group {{ $errors->has('orientation') ? 'has-error' : ''}}">
...
<div class="col-md-12 form-group  {{ $errors->has('commentaire') ? 'has-error' : ''}}">
