<div class="form-group {{ $errors->has('civilité') ? 'has-error' : ''}}">
...
<div class="form-group {{ $errors->has('email') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="email" type="text" id="email" value="{{ isset($client->email) ? $client->email : ''}}" required>
