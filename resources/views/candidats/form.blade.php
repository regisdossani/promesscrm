...
<div class="col-md-6 {{ $errors->has('adresse') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="adresse" type="text" id="adresse" value="{{ isset($candidat->adresse) ? $candidat->adresse : ''}}">
    {!! $errors->first('adresse', '<p class="help-block">:message</p>') !!}
</div>
<div class="col-md-6 ">
    <label for="prenom" class="control-label">{{ 'Prénom :' }}</label>
    <input class="form-control" name="prenom" type="text" id="prenom" value="{{ isset($candidat->prenom) ? $candidat->prenom : ''}}">
...
@role('superadmin')
<div class="col-md-12  {{ $errors->has('depot_dossier') ? 'has-error' : ''}}">
...
<div class="col-md-3  {{ $errors->has('test_ecrit') ? 'has-error' : ''}}">
...
<div class="col-md-3  {{ $errors->has('test_oral') ? 'has-error' : ''}}">
...
<div class="col-md-6  {{ $errors->has('pj_depotdossier') ? 'has-error' : ''}}">
...
<div class="col-md-6 {{ $errors->has('orientation') ? 'has-error' : ''}}">
    ...
    <input type="text" class="form-control" name="orientation" id="orientation" value="{{ isset($candidat->orientation) ? $candidat->orientation : ''}}" placeholder="orientation">
    {!! $errors->first('orientation', '<p class="help-block">:message</p>') !!}
</div>

<div class="col-md-12   {{ $errors->has('commentaire') ? 'has-error' : ''}}">
    <label class="control-label" for="commentaire">Commentaire</label>
    <textarea name="commentaire" class="form-control" id="commentaire" cols="30" rows="4" placeholder="commentaire">{{ isset($candidat->commentaire) ? $candidat->commentaire : ''}}</textarea>
    {!! $errors->first('commentaire', '<p class="help-block">:message</p>') !!}
</div>
@endrole

<div style="margin-bottom: 10px;" class="col-md-6 {{ $errors->has('avatar') ? 'has-error' : ''}}">
