				...
				<!--notification start-->
					...
					<div class="notify-w3ls">
						<div class="alert alert-info clearfix">
							...
							<div class="notification-info">
								<ul class="clearfix notification-meta">
									...
									<li class="pull-right notification-time">il y'a 1 min</li>
								</ul>
								<p>
									Réunion Urgente
								</p>
						...
						<div class="alert alert-success ">
							...
							<div class="notification-info">
								<ul class="clearfix notification-meta">
									<li class="pull-left notification-sender">Vous avez 5 message non lus</li>
									<li class="pull-right notification-time">Il y'a 1 min </li>
								</ul>
								<p>
									<a href="#">Anjelina Mewlo, Jack Flip</a> et <a href="#">3 autres</a>
								</p>
							</div>
						</div>
						<div class="alert alert-warning ">
							...
							<div class="notification-info">
								...
								<p>
									Prochain 5 Jeudi  juilet est le dernier jour.
								</p>
							</div>
						</div>
						<div class="alert alert-info clearfix">
							...
							<div class="notification-info">
								<ul class="clearfix notification-meta">
									<li class="pull-left notification-sender"><span><a href="#">Jonathan Smith</a></span> send you a mail </li>
									<li class="pull-right notification-time">Il y'a 1 min ago</li>
								</ul>
								<p>
									Rénion Urgente
								</p>
