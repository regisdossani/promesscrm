...
class NewchantiersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($keyword)) {
            $newchantier = Newchantier::latest()->paginate($perPage);
        } else {
            $newchantier = Newchantier::latest()->paginate($perPage);
        }

        return view('.index', compact('newchantier'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('')->with('flash_message', 'Newchantier added!');
    }
    ...
    public function show($id)
    {
        ...
        return view('.show', compact('newchantier'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('.edit', compact('newchantier'));
    }
