...
<div class="form-group {{ $errors->has('activite_entreprise') ? 'has-error' : ''}}">
    <label for="activite_entreprise" class="control-label">{{ 'Activite Entreprise' }}</label>
...
<div class="form-group {{ $errors->has('contact_tel') ? 'has-error' : ''}}">
    <label for="contact_tel" class="control-label">{{ 'Contact Tel' }}</label>
...
<div class="form-group {{ $errors->has('contact_email') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="contact_email" type="text" id="contact_email" value="{{ isset($entreprise->contact_email) ? $entreprise->contact_email : ''}}" >
