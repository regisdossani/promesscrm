...
<div class="form-group {{ $errors->has('contratcadre') ? 'has-error' : ''}}">
...
@endif
<div class="form-group {{ $errors->has('Contratcadre_pj') ? 'has-error' : ''}}">
...
@endif
<div class="form-group {{ $errors->has('CV_pj') ? 'has-error' : ''}}">
...
<div class="form-group {{ $errors->has('specialites') ? 'has-error' : ''}}">
...
<div class="form-group {{ $errors->has('autres_activites') ? 'has-error' : ''}}">
...
<div class="form-group {{ $errors->has('formation_07_2018') ? 'has-error' : ''}}">
...
<div class="form-group {{ $errors->has('formation_01_2019_') ? 'has-error' : ''}}">
...
<div class="form-group {{ $errors->has('formation_securite_06_2019') ? 'has-error' : ''}}">
