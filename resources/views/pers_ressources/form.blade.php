...
<div class="col-md-6 {{ $errors->has('piece_jointe') ? 'has-error' : ''}}">
...
<div class="col-md-6 {{ $errors->has('nature_personne_ressource') ? 'has-error' : ''}}">
...
<div class="col-md-6 {{ $errors->has('objet_du_contact') ? 'has-error' : ''}}">
