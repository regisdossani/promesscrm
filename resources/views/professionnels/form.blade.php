...
<div class="form-group {{ $errors->has('zone_geographique') ? 'has-error' : ''}}">
...
<div class="form-group {{ $errors->has('thematiques_intervention') ? 'has-error' : ''}}">
...
<div class="form-group {{ $errors->has('mode_collaboration') ? 'has-error' : ''}}">
...
<div class="form-group {{ $errors->has('nature_activite') ? 'has-error' : ''}}">
...
<div class="form-group {{ $errors->has('nature_commentaire') ? 'has-error' : ''}}">
...
<div class="form-group {{ $errors->has('nombre_employe') ? 'has-error' : ''}}">
...
<div class="form-group {{ $errors->has('zone_intervention') ? 'has-error' : ''}}">
...
<div class="form-group {{ $errors->has('exemple_realisation') ? 'has-error' : ''}}">
